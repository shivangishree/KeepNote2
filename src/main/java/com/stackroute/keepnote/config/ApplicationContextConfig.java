//Step 3: In ApplicationContextConfig.java add the required annotations, 
//as well as add base packages to scan in @componentScan Annotation.
//Define the bean for DataSource, SessionFactory and Transaction Manager.
